...
class MenuContribution extends StatefulWidget {
  const MenuContribution({Key? key}) : super(key: key);

  @override
  State<MenuContribution> createState() => _MenuContributionState();
}

class _MenuContributionState extends State<MenuContribution> {
            ...
            child: Column(children: [
                  ...
                  children: [
                    IconButton(
                      icon: const Icon(Icons.arrow_back,
                          color: Color(0xff4D89EC), size: 30),
                      onPressed: () {},
                    ),
                    Spacer(),
                    Text(
                  ...
                  children: [
                    ConstrainedBox(
                      ...
                      child: ElevatedButton(
                        style: ButtonStyle(
                            backgroundColor:
                                MaterialStateProperty.all<Color>(clr1),
                    ...
                    ConstrainedBox(
                        ...
                        child: ElevatedButton(
                          style: ButtonStyle(
                              backgroundColor:
                                  MaterialStateProperty.all<Color>(clr2),
                              shape: MaterialStateProperty.all(
                                  const RoundedRectangleBorder(
                                borderRadius: BorderRadius.only(
                ...
                child: Padding(
                  ...
                  child: Container(
                      ...
                      child: ListView.separated(
                        ...
                        itemCount: maincourse ? plats.length : entree.length,
                        shrinkWrap: true,
              ...
              Padding(
                  ...
                  child: ConstrainedBox(
                    constraints:
                        const BoxConstraints.tightFor(width: 160, height: 50),
                    child: ElevatedButton(
                      style: ButtonStyle(
                          backgroundColor:
